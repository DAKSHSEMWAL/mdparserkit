    ...
    lines.forEach { line ->
        when {
            ...
            line.startsWith("# ") -> {
                ...
                textMarkDown(content, resultBuilder, fontSize = 24.sp, fontWeight = FontWeight.Bold)
            }
            ...
            line.startsWith("### ") -> {
                val content = line.removePrefix("### ").trim()
                textMarkDown(content, resultBuilder, fontSize = 18.sp, fontWeight = FontWeight.Bold)
            }
            // Heading 4
            line.startsWith("#### ") -> {
                val content = line.removePrefix("#### ").trim()
                textMarkDown(content, resultBuilder, fontSize = 16.sp, fontWeight = FontWeight.Bold)
            }
            // Heading 5
            line.startsWith("##### ") -> {
                val content = line.removePrefix("##### ").trim()
            ...
            line.startsWith("###### ") -> {
                val content = line.removePrefix("###### ").trim()
                textMarkDown(content, resultBuilder, fontSize = 12.sp, fontWeight = FontWeight.Bold)
            }
